# Tektronix-4051-Emulator-file-conversion
...
A simple program for use with text files, specifically source code e.g. BASIC programs written in e.g. notepad. It will convert the file and filename to be compatible with the flash drive format used by the very cool and groovy Tektronix 4051 emulator ( https://github.com/mmcgraw74/Tektronix-4051-Emulator ).
